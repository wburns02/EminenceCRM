...
import { useAIAlerts, useGenerateDealSummary, useScoreBuyers } from '@/api/hooks/useAI'
...
function CIMAssistantPanel() {
  ...
  const handleGenerate = async () => {
    ...
    setContent(
      `[AI-Generated ${selectedSection}]\n\nThis section provides a comprehensive overview of the ${selectedSection.toLowerCase()} for the selected engagement. In production, this content would be generated by the AI model based on deal data, financials, and market intelligence.\n\nKey highlights:\n- Strong market position\n- Consistent revenue growth\n- Experienced management team\n- Multiple growth opportunities identified`
    )
    setGenerating(false)
  }
